...
jokes = [
    ...
    {"setup": "Why do Python programmers wear glasses?", "punchline": "Because they can't C!"},
    {"setup": "What's a computer's favorite beat?", "punchline": "An algo-rhythm!"},
    {"setup": "Why was the JavaScript developer sad?", "punchline": "Because he didn't Node how to Express himself!"},
    {"setup": "What did the router say to the doctor?", "punchline": "It hurts when IP!"},
    {"setup": "Why did the developer go to therapy?", "punchline": "Because he had too many issues to commit to!"},
    {"setup": "What is a programmer's favorite hangout place?", "punchline": "The Foo Bar!"},
    {"setup": "Why do programmers always mix up Halloween and Christmas?", "punchline": "Because Oct 31 == Dec 25!"},
    {"setup": "What did the Java code say to the C code?", "punchline": "You've got no class!"},
    {"setup": "Why did the developer go to art school?", "punchline": "To learn how to draw an interface!"},
    {"setup": "What do you call 8 hobbits?", "punchline": "A hobbyte!"},
    {"setup": "Why are assembly programmers always on time?", "punchline": "Because they work on the clock cycle!"},
    {"setup": "What do you call a sleeping dinosaur?", "punchline": "A dino-snore... wait wrong repo!"},
    {"setup": "Why did the database administrator leave his wife?", "punchline": "She had one-to-many relationships!"},
    ...
    {"setup": "What do you call a programmer who doesn't comment their code?", "punchline": "A sociopath!"},
    ...
    {"setup": "Why did the programmer use dark mode?", "punchline": "Because bugs are afraid of the dark!"},
    {"setup": "What did the tech lead say before the sprint?", "punchline": "This should only take 2 hours!"},
